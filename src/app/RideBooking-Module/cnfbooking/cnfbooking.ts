...
// userid: number | undefined = (JSON.parse(localStorage.getItem("user")!) as { userId: number }).userId;
...
//   bookRide() {
//     console.log("The UserId is this"+this.userid);
...
//       // confirmed: false, 
//       //  cancelled: false,
//       // createdAt: new Date().toISOString() // ISO format for LocalDateTime
//     }
...
//             this.router.navigate(['/userhomenav/bookingWaiting'], {
